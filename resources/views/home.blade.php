...
<a href="create">
<img src="{{asset('an.png')}}"  height="200" width="300" style="position:absolute;"> </a>

 <center>
  <div  style="width: 40%;" class="panel panel-primary">
 ...
 <div class="panel panel-info" style="width: 70%;"  >
      ...
      <div class="panel panel-default"><h2>MES CONTRIBUTIONS 
...
<a href="{{url('watch/'.$ncnb->id)}}"><img src="{{asset('Video.jpg')}}" class="img-circle" height="200" width="50"></a>@endif
 ...
 <center><p><a href="{{url('edite/'.$ncnb->id)}}" class="btn btn-info" role="button">UPDATE</a> <a1 href="{{url('delete/'.$ncnb->id)}}" role="button" class="btn btn-danger">DELETE {{$ncnb->id}}</a1></p>
 {{$ncnb->created_at}}
